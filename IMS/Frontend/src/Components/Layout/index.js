...
import MaintenanceCard from "./../Pages/Maintenance/Cards/MaintenanceCard/index";
import AgencyCard from "./../Pages/Maintenance/Cards/AgencyCard/index";
import MaintenancePieChart from '../Utils/Charts/Charts/MaintenancePieChart/index';
  ...
  if(props.torender === "maintenance")
  {
    ...
    <div className="fe-maintenance-cards-search">
      ...
      <div className="fe-maintenance-search">
        <SearchBar search="Maintenance" handleResult={handleResult}/>
      </div>
    </div>
    <div className="fe-maintenance-table-chart">
      <div className="fe-maintenance-table-data">
        <MaintenanceTable type={t} pname={name1} className="fe-maintenance-table-main"/>
      </div>
      <div>
        <MaintenancePieChart />
      </div>
